	...
	$('table').each(function() {
		if($(this).find('thead').length > 0 && $(this).find('th').length > 0) {
			...
			var $stickyHead  = $(this).siblings('.sticky-thead'),
				...
				$stickyWrap  = $(this).parent('.table-responsive');
			...
			$stickyInsct.html('<thead><tr><th>'+$t.find('thead th').html()+'</th></tr><tr><th>'+$t.find('thead tr:nth-child(2) th').html()+'</th></tr></thead>');
			...
			$t.parent('.table-responsive').scroll(function() {
